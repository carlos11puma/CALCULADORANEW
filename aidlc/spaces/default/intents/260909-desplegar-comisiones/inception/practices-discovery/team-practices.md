# Team Practices — 260909-desplegar-comisiones

> Practices Discovery para un intent de alcance `infra`: llevar a
> infraestructura real (Neon/Render/Expo-EAS) la app ya construida en el
> intent `260908-calculadora-comisiones-m`. Way of Working, Testing Posture y
> Code Style están afirmados en `memory/team.md` y se heredan sin cambios.
> Walking Skeleton no aplica a este intent. El contenido específico y nuevo
> vive en `## Deployment`, fijado por decisión humana de Carlos en la
> entrevista (Step 4).
